...
public class RangeSeekBar<T extends Number> extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.ic_thumb);
     ...
     */
    public static final int DEFAULT_COLOR = Color.argb(0xFF, 0xF5, 0xCB, 0x45);
    /**
