...
class CompleteCancelOrder : BaseActivity<LayoutCancelOrderBinding>(), CancelOrderContract,
...
//                        }
                      //  Log.e("product_image",product_image)
                        ...
                        myDialog.dialogShow()
                            cancelOrderPresenter?.completeCancelOrder(order_id, reason!!,imageList)
        ...
        TedPermission.with(this)
            .setPermissionListener(object : PermissionListener {
                override fun onPermissionGranted() {
                    bsd = BottomSheetDialog(this@CompleteCancelOrder)
